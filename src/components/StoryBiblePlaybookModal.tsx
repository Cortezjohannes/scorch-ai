    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 overflow-y-auto">
        <motion.div
          ...
          className="bg-[#1a1a1a] border border-[#10B981] rounded-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden flex flex-col shadow-[0_0_50px_rgba(0,255,153,0.3)]"
          >
            {/* Header */}
          <div className="bg-gradient-to-r from-[#10B981]/20 to-transparent p-6 border-b border-[#10B981]/30">
          ...
          {/* Navigation */}
          <div className="flex border-b border-[#10B981]/20 bg-black/30">
            {[
              ...
              { id: 'tips', label: '💡 Pro Tips', color: 'text-[#10B981]' }
            ].map((section) => (
              <button
                key={section.id}
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            {activeSection === 'essential' && (
              <div className="space-y-6">
                ...
                <div className="bg-[#2a2a2a] border border-[#10B981]/20 rounded-lg p-6">
                  <h4 className="text-xl font-bold text-[#10B981] mb-3 flex items-center">
                    <span className="text-2xl mr-2">1️⃣</span>
                    Story Overview Tab
                  </h4>
                  <div className="space-y-3 text-white/90">
                    <p><strong className="text-[#10B981]">Why Essential:</strong> This is your story's DNA. Everything flows from here.</p>
                    <p><strong className="text-[#10B981]">What to Learn:</strong></p>
                    ...
                    <div className="bg-black/50 p-4 rounded border border-[#10B981]/10 mt-3">
                ...
                <div className="bg-[#2a2a2a] border border-[#10B981]/20 rounded-lg p-6">
                  ...
                  <div className="space-y-3 text-white/90">
                    <p><strong className="text-[#10B981]">Why Essential:</strong> Characters drive your story. Know them like real people.</p>
                    <p><strong className="text-[#10B981]">What to Learn:</strong></p>
                    <ul className="list-disc list-inside space-y-2 ml-4 text-white/80">
                ...
                <div className="bg-[#2a2a2a] border border-[#10B981]/20 rounded-lg p-6">
                  ...
                  <div className="space-y-3 text-white/90">
                    <p><strong className="text-[#10B981]">Why Essential:</strong> Your roadmap. Know where you're going.</p>
                    <p><strong className="text-[#10B981]">What to Learn:</strong></p>
                    <ul className="list-disc list-inside space-y-2 ml-4 text-white/80">
                ...
                <div className="bg-orange-500/10 border-2 border-orange-500/50 rounded-lg p-6">
                  ...
                  <div className="space-y-3 text-white/90">
                    ...
                    <div className="bg-black/50 p-4 rounded border border-orange-500/30 mt-4">
                      <p className="text-[#10B981] font-bold mb-2">✏️ You Can Edit Everything!</p>
                      <p className="text-sm text-white/80">
                        Click the <span className="text-[#10B981]">✏️ Edit</span> button next to any name, title, 
            ...
            {activeSection === 'recommended' && (
              <div className="space-y-6">
                ...
                {/* World Building */}
                <div className="bg-[#2a2a2a] border border-[#10B981]/20 rounded-lg p-6">
                  <h4 className="text-xl font-bold text-[#10B981] mb-3">
                    🌍 World Building Tab
                  </h4>
                  <div className="space-y-3 text-white/90">
            ...
            {activeSection === 'tips' && (
              <div className="space-y-6">
                ...
                {/* Tip 1: Regeneration */}
                <div className="bg-[#2a2a2a] border-l-4 border-[#10B981] rounded-lg p-6">
                  <h4 className="text-xl font-bold text-[#10B981] mb-3">
                  ...
                  <div className="space-y-3 text-white/90">
                    ...
                    <p className="font-bold text-[#10B981] mt-4">How to Get Better Results:</p>
                    <ul className="list-disc list-inside space-y-2 ml-4 text-white/80">
                    ...
                    <div className="bg-[#10B981]/10 border border-[#10B981]/30 p-4 rounded mt-4">
                      <p className="font-bold text-[#10B981] mb-2">💎 Pro Move: Edit Instead of Regenerate</p>
                      <p className="text-sm text-white/80">
                ...
                <div className="bg-[#2a2a2a] border-l-4 border-[#10B981] rounded-lg p-6">
                  ...
                  <div className="space-y-3 text-white/90">
                    ...
                    <p className="font-bold text-[#10B981]">Common Edits:</p>
                    <ul className="list-disc list-inside space-y-2 ml-4 text-white/80">
                ...
                <div className="bg-[#2a2a2a] border-l-4 border-[#10B981] rounded-lg p-6">
                  ...
                  <div className="space-y-3 text-white/90">
                    ...
                    <p className="font-bold text-[#10B981]">How to Use Arc Suggestions:</p>
                    <ul className="list-disc list-inside space-y-2 ml-4 text-white/80">
                ...
                <div className="bg-[#2a2a2a] border-l-4 border-[#10B981] rounded-lg p-6">
                  ...
                  <div className="space-y-3 text-white/90">
                    <p className="font-bold text-[#10B981]">Before Creating Episode 1:</p>
                    ...
                    <p className="font-bold text-[#10B981] mt-4">While Creating Episodes:</p>
                    <ol className="list-decimal list-inside space-y-2 ml-4 text-white/80">
                    ...
                    <p className="font-bold text-[#10B981] mt-4">After 5-10 Episodes:</p>
                    <ol className="list-decimal list-inside space-y-2 ml-4 text-white/80">
          ...
          {/* Footer */}
          <div className="border-t border-[#10B981]/20 p-4 bg-black/30 flex justify-between items-center">
            <div className="text-sm text-white/60">
              💡 Tip: Keep this playbook handy while creating your first few episodes
            </div>
            <button
              onClick={onClose}
              className="bg-gradient-to-r from-[#10B981] to-[#059669] text-black px-6 py-2 rounded-lg font-semibold hover:shadow-[0_0_20px_rgba(0,255,153,0.5)] transition-all"
            >
              Got It!
            </button>
          </div>
