    ...
    <div className="space-y-6">
      ...
      <Card className="border border-[#36393f] shadow-md">
        ...
        <CardContent className="p-5 space-y-4">
          <div>
            <h3 className="text-lg font-semibold text-[#10B981] mb-2">Overall Visual Aesthetic</h3>
          ...
          {visualStyle.cinematicReferences && visualStyle.cinematicReferences.length > 0 && (
            <div>
              <h3 className="text-lg font-semibold text-[#10B981] mb-2">Cinematic References</h3>
          ...
          <div className="flex flex-wrap gap-2 pt-3">
            <div className="bg-[#232427] border border-[#36393f] rounded-md px-3 py-1 text-sm font-medium text-[#10B981]">
              Cinematic
            </div>
