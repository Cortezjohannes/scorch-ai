          ...
          >
            ...
            <div className="overflow-y-auto max-h-[calc(90vh-120px)] p-6 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-[#00FF99]/10 border border-[#00FF99]/30 rounded-lg p-4">
                  <p className="text-[#00FF99] font-semibold text-lg">
              ...
              <section className="space-y-6">
                <h2 className="text-xl font-bold text-[#00FF99] font-[family-name:var(--font-inter)]">
                ...
                <div className="bg-[#2a2a2a] rounded-lg p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-[#00FF99]"><strong>Pro Tip:</strong> Focus on the irony or the inherent conflict.</p>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 mt-6">
                    ...
                    <div className="bg-[#1a1a1a] border border-[#00FF99]/30 rounded-lg p-4">
                      <h4 className="text-[#00FF99] font-semibold mb-2">✨ S-Tier Input</h4>
                ...
                <div className="bg-[#2a2a2a] rounded-lg p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-[#00FF99]"><strong>Pro Tip:</strong> Define their internal need vs. their external want. What is their biggest flaw that the story will exploit?</p>
                  </div>
                ...
                <div className="bg-[#2a2a2a] rounded-lg p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-[#00FF99]"><strong>Pro Tip:</strong> Define the ticking clock. Stakes must be personal and immediate.</p>
                  </div>
                ...
                <div className="bg-[#2a2a2a] rounded-lg p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-[#00FF99]"><strong>Pro Tip:</strong> Use the "X meets Y" format and specific tonal keywords (e.g., Gritty, Witty, Claustrophobic, Stylized).</p>
                  </div>
                ...
                <div className="bg-[#2a2a2a] rounded-lg p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-[#00FF99]"><strong>Pro Tip:</strong> Keep it simple and universal. (e.g., "The illusion of control," "Found family," "The cost of ambition.")</p>
                  </div>
                </div>
              </section>
              ...
              <section className="space-y-6">
                ...
                <div className="bg-[#2a2a2a] rounded-lg p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      <h4 className="text-[#00FF99] font-semibold">Logline:</h4>
                      <p className="text-white">"When the quietest girl in school starts an anonymous gossip account to expose the popular clique's hypocrisy, she must decide how far she'll go when the account turns toxic."</p>
                    </div>
                    <div>
                      <h4 className="text-[#00FF99] font-semibold">Protagonist:</h4>
                    ...
                    <div>
                      <h4 className="text-[#00FF99] font-semibold">Stakes:</h4>
                    ...
                    <div>
                      <h4 className="text-[#00FF99] font-semibold">Vibe:</h4>
                      <p className="text-gray-300">Gritty, stylized, secrets. "Euphoria" meets "Mean Girls."</p>
                    </div>
                    <div>
                      <h4 className="text-[#00FF99] font-semibold">Theme:</h4>
              ...
              {/* Footer */}
              <div className="bg-[#00FF99]/10 border border-[#00FF99]/30 rounded-lg p-6 text-center">
