      ...
      <div className="mb-10">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <h2 className="text-2xl font-bold text-white flex items-center">
            <Lightbulb className="mr-2 h-5 w-5 text-[#10B981]" />
            Story Templates
          </h2>
        ...
        {filteredRecommendations.map((recommendation, index) => (
          ...
          >
            <Card className="h-full border border-[#36393f] bg-[#1e1e1e] hover:border-[#10B981]/50 transition-all hover:shadow-[0_0_15px_rgba(0,255,153,0.1)] overflow-hidden">
              ...
              <CardContent className="pt-0 space-y-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {recommendation.tags.map((tag) => (
                    <span key={tag} className="text-xs text-gray-400 px-2 py-0.5 bg-[#2a2a2a] rounded-full flex items-center">
                      <Tag className="h-3 w-3 mr-1 text-[#10B981]" />
                          {tag}
                        </span>
                      ))}
                    </div>
                ...
                <div className="flex items-center">
                  ...
                  {recommendation.recommendedMode === 'beast' ? (
                    <span className="text-xs flex items-center px-2 py-1 bg-[#10B981]/20 text-[#10B981] rounded-full">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="w-full mt-2 border-[#10B981]/30 text-[#10B981] hover:bg-[#10B981]/10"
                >
